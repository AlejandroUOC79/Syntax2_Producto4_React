    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.description}>
          Análisis técnico: Jugador con gran capacidad de salto y precisión en
          el tiro exterior. Clave en la estrategia de Syntax2 - BasketTech.
        </Text>

        <TouchableOpacity
          style={styles.videoButton}
          onPress={() =>
            navigation.navigate("Reproductor", { videoUrl: player.video })
          }
        >
